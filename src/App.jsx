...
function App() {
  ...
  const [credits, setCredits] = useState(
    localStorage.getItem("googleUser")
      ? JSON.parse(localStorage.getItem("googleUser")).credits
      : 0
  );
  ...
  const handleNewHistory = () => {
    if (
      newHistory.date_played &&
      newHistory.home_team &&
      newHistory.away_team &&
      newHistory.home_odds &&
      newHistory.draw_odds &&
      newHistory.away_odds
    ) {
    ...
    if (confirm("Are you sure you want to upload and finish?")) {
      try {
        const response = await fetch(
          "https://carshare-mpesa.vercel.app/api/add_history",
          {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
  ...
  return (
    <GoogleOAuthProvider clientId={REACT_APP_GOOGLE_CLIENT_ID}>
        ...
        <Fade in={open} className="payment">
          ...
          { !processingPayment ? (
            <div>
              ...
              />
              <div className="small mt-3" style={{ color: "" }}>
                Credits (minimum 15)
              </div>
              <input
                type="number"
      ...
      <nav className="Navigation">
        <div className="navBar">
          ...
          <div className="d-flex justify-content-center align-items-center gap-2 fs-5 position-relative">
            <div
              role="button"
              className="userProfile d-flex align-items-center gap-3"
            ...
            >
              ...
              {showProfile && (
                <div
                  ref={profileRef}
                  className="border small rounded-4 p-3 w-100 profile"
                  style={{
                    position: "absolute",
                    right: "0",
                    top: "50px",
                  ...
                  {user ? (
                    <>
                      <div className="mb-3 mt-2">
                        ...
                        <small className="" style={{ color: "blueviolet" }}>
                          {user.email}
                        </small>
                      </div>
                      <div className="d-flex flex-column gap-2">
                        ...
                        <button
                          className="btn p-1 bg-danger small mt-2 rounded-pill border-0 outline-0 text-light d-flex justify-content-center align-items-center gap-2"
                          onClick={() => {
                            googleLogout();
                            setUser(null);
      ...
      <div className="heroSection my-4 d-flex flex-column justify-content-center align-items-center text-center gap-2">
        <button
          className="btn btnLight small px-4 rounded-pill border-0 outline-0"
          style={{ pointerEvents: "none" }}
        >
          Simplify Your Betting Experience
        </button>
        <h1>
          Enhance your prediction <br /> control with Blexy
        </h1>
        <p className="small" style={{ lineHeight: 2 }}>
          Streamline your betting experience with our intuitive platform that
          empowers you to make informed decisions. Blexy helps you predict
          Betika Midweek Jackpot Accurately. You can also use it to predict
          other jackpot games!
        </p>
        <button
          className="btn small p-2 px-5 rounded-pill border-0 outline-0 text-light"
    ...
    />
        ...
        <div className="mt-4 mb-4 d-grid container stats">
          ...
          >
            ...
            <small className="small">
              ...
              left behind. Be among the best/wise betters now.
            </small>
          </div>
          <div
            className="rounded-4"
          ...
          >
            ...
            <small className="small">
              Our system delivers predictions in seconds, ensuring you get
              results quickly and efficiently for your betting needs.
            </small>
          </div>
          <div
            className="rounded-4"
          ...
          >
            ...
            <small className="small">
              ...
              handpicked matches for highest quality prediction.
            </small>
          </div>
          <div
            className="rounded-4"
          ...
          >
            ...
            <small className="small">
              ...
              thousands of data & cutting-edge analytics.
            </small>
          </div>
        </div>
      </div>
      ...
      <div className="d-flex justify-content-center align-items-center gap-2 flex-wrap mt-4 mb-5">
        <button
          className={`btn small ${
            mode === "Today" ? "btnLight" : ""
          } small px-4 rounded-pill border-0 outline-0`}
      ...
      <div className="container mb-4 bg-black text-light p-5 betsContainer">
        {mode === "Past" ? (
              ...
              <table className="w-100 bg-transparent text-light">
                ...
                <tbody>
                  {history.length > 0 ? (
                    ...
                    <tr>
                      <td colSpan="8" className="text-center p-3 py-5">
                        No data
                      </td>
                    </tr>
                  )}
                  ...
                  {/* {showAddHistory && (
                    <tr className="text-light newMatch">
                      ...
                      <td className="py-3 small">
                        <input
                          type="text"
                          value={newHistory.home_odds}
                          onChange={(e) =>
                            setNewHistory({
                              ...newHistory,
                              home_odds: e.target.value
                                .replace(/[^0-9.]/g, "")
                                .replace(/^0+(?!\.)/, ""),
                            })
                          }
                      ...
                      <td className="py-3 small">
                        <input
                          type="text"
                          value={newHistory.draw_odds}
                          onChange={(e) =>
                            setNewHistory({
                              ...newHistory,
                              draw_odds: e.target.value
                                .replace(/[^0-9.]/g, "")
                                .replace(/^0+(?!\.)/, ""),
                            })
                          }
                      ...
                      <td className="py-3 small">
                        <input
                          type="text"
                          value={newHistory.away_odds}
                          onChange={(e) =>
                            setNewHistory({
                              ...newHistory,
                              away_odds: e.target.value
                                .replace(/[^0-9.]/g, "")
                                .replace(/^0+(?!\.)/, ""),
                            })
                          }
                      ...
                      <td className="py-3 small">
                        ...
                        >
                          ...
                          <option className="text-dark" value="X">
                            Draw
                          </option>
          ...
          <div className="today position-relative overflow-x-auto">
            <div className="mb-3 text-center fw-bolder text-success">
              ...
              <table className="w-100 bg-transparent text-light">
                ...
                <tbody>
                  {today.length > 0 ? (
                    ...
                    <tr>
                      <td colSpan="8" className="text-center p-3 py-4">
                        No data
                      </td>
                    </tr>
                  )}
                    ...
                    <tr className="text-light newMatch">
                      ...
                      <td className="py-3 small">
                        <input
                          autoFocus
                          type="date"
                          value={newMatch.date_to_play}
                          onChange={(e) =>
                            setNewMatch({
                              ...newMatch,
                              date_to_play: e.target.value,
                            })
                          }
                          className="form-control"
                          placeholder="Date To Play"
                        />
                      </td>
                      <td className="py-3 small">
                        <input
                ...
                !showAddMatch ? (
                  <>
                    {today.length < 15 && (
                      <button
                        style={{ minWidth: "30%" }}
                        className="btn small p-2 rounded-pill border-0 outline-0 bg-black text-primary btnLight"
                  ...
                  <>
                    <button
                      style={{ minWidth: "25%" }}
                      className="btn small p-2 rounded-pill outline-0 bg-black text-success border border-success"
                    ...
                    <button
                      style={{ minWidth: "25%" }}
                      className="btn small p-2 rounded-pill border-0 outline-0 bg-black text-danger"
              ...
              <div className="history position-relative overflow-x-auto">
                <div className="mb-4 text-center fw-bolder text-success">
                  <p>
                    ...
                    {new Date("07-20-2025").toLocaleString()})
                  </p>
                </div>
                <div className="w-100 p-2 overflow-x-auto">
                  <table className="w-100 bg-transparent text-light">
                            ...
                            <tbody>
                              {predictions.predictions.map((item, index) => (
                                <tr key={index} className="text-light">
                                  ...
                                  <td className="py-3 small">{item.draw_odds}</td>
                                  <td className="py-3 small">{item.away_odds}</td>
                                  <td className="py-3 small fw-bold">
                                    {item.prediction === 0
                                      ? "1 (Home Win)"
                                      : item.prediction === 1
                                      ? "X (Draw)"
      ...
      <nav className="Navigation mt-4">
        <div className="navBar">
          <small>© 2025 Blexy. All rights reserved.</small>
